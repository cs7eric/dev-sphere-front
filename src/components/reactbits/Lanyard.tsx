...
import cardGLB from "@/assets/lanyard/card_new.glb";
...
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true }) {
  return (
    <div className="relative w-full h-screen z-[999] flex justify-center items-center transform scale-100 origin-center">
      <Canvas
